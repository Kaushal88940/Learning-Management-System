...
const MEDIA_API = "http://127.0.0.1:3001/api/v1/media";
  ...
  const fileChangeHandler = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        // Ensure the response is in the correct format and log it
        ...
        e.target.value = null; // allow re-selection of the same file
      }
    }
  };
