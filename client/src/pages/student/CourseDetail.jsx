...
const CourseDetail = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#2D2F31] text-white">
        <div className="max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2 text-sm">
            <BadgeInfo size={16} />
            <p>
              Last updated {course?.createdAt ? course.createdAt.split("T")[0] : "N/A"}
            </p>
          </div>
      ...
      {/* Course Content */}
      <div style={{height: "600px"}} className="max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-10">
        ...
        <div className="w-full lg:w-1/3">
          <Card>
            <CardContent className="p-4 flex flex-col">
              ...
              <h1 className="text-lg md:text-xl font-semibold">₹{course?.coursePrice || "N/A"}</h1>
            </CardContent>
